...
Локално: frontend build, 23/23 unit/render теста и 6/6 целеви Chromium теста
на desktop/mobile минават. Публичният docs proxy отвръща локално с доверен
TLS и HTTP 200 за BG/EN; проверката отвън и публикуването на frontend от main
се документират отделно. Първа реална клиентска покана още не е изпратена или
приета. Сертификатът за docs е с ръчно DNS-01 и няма автоматично подновяване;
виж `gridex-docs/README.md`.
