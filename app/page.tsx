...
function ConfirmedProtocolMaps({lang}:{lang:UiLanguage}) {
  const t=(bg:string,en:string)=>lang==="en"?en:bg;
  const confirmed=[
    {brand:"Suntech",model:"SunPro / SunStorage Pro 261",type:t("All-in-one BESS · 261 kWh","All-in-one BESS · 261 kWh"),protocol:"EMS Modbus",scope:t("PCS, BCQ controller, BMS/BAU, телеметрия и команди","PCS, BCQ controller, BMS/BAU, telemetry and commands"),status:t("Карта получена","Map received")},
