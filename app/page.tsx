...
function HeartbeatEmailOptIn({api,lang,helpHref}:{api:GridexApiClient;lang:UiLanguage;helpHref:string}) {
  ...
  return <article className="card profile-panel heartbeat-email-opt-in">
    ...
    <div className="profile-notification-details"><span>{t('Работи сега','Available now')}</span><strong>{t('Загуба на връзка с ROCK Pi или ESP32 · 1 имейл на прекъсване','ROCK Pi or ESP32 connection loss · 1 email per outage')}</strong></div>
