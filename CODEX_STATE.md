...
## Първа документационна страница и права — 2026-09-26

В `docs/ORGANISATIONS_AND_ACCESS.md` и съществуващата `/help/` е подготвено
BG/EN обяснение: реален достъп само с покана; отделна организация/realm;
глобален администратор кани първия администратор, той кани своите членове;
приемане и изрични права по Обект. Setup client не е човешки вход. Пази
пилотния акаунт и одобрената структура на менюто. Backend е активен, но
първата реална клиентска покана не е проверена от край до край. Frontend
промените в този branch са локални и непубликувани. Старите „not deployed“
записи по-долу са исторически; виж HANDOFF и backend плана.
